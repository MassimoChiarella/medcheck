...
export const products = sqliteTable('products', { id: text().primaryKey(), data: text().notNull(), observed: text().notNull(), searchText:text().notNull().default('') });
...
export const cvProducts = sqliteTable('cv_products', { gen: text().notNull(), id: integer().notNull(), name: text().notNull(), ingredients: text().notNull(), searchText:text().notNull().default('') },t=>[primaryKey({columns:[t.gen,t.id]}),index('cv_product_name').on(t.gen,t.name)]);
...
export const dpdStaging = sqliteTable('dpd_staging', { gen: text().notNull(), id: text().notNull(), data: text().notNull(), hash: text().notNull(), versionData: text().notNull(), searchText:text().notNull().default('') },t=>[primaryKey({columns:[t.gen,t.id]})]);
