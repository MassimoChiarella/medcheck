...
Owners can enable GitHub's built-in Actions notifications in their personal **Settings → Notifications → Actions** and choose failed-workflow email notifications. Those personal delivery preferences are not configured by this repository. No additional email service or patient-facing alert is installed. See [GitHub notification settings](https://docs.github.com/en/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/configuring-notifications).
